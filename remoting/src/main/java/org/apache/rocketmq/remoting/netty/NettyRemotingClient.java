...
public class NettyRemotingClient extends NettyRemotingAbstract implements RemotingClient {
    ...
    private final NettyClientConfig nettyClientConfig; // Netty配置信息
    private final Bootstrap bootstrap = new Bootstrap(); // 客户端辅助类
    private final EventLoopGroup eventLoopGroupWorker; // 工作线程组
    private final Lock lockChannelTables = new ReentrantLock(); // channel锁
    // <Key:连接通信地址，Value:ChannelWrapper>
